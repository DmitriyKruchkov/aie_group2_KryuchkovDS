...
- **Название проекта:** `Предсказание выживания SPOT-инстанса для GPU-джоб в AWS при заданной цене в течение суток`
- **Автор:** `Крючков Дмитрий Сергеевич`
- **Группа:** `ИНБО-08-22`
- **Контакт:** `@hkvge`

- **Краткое описание (2-4 предложения):**  
  `В AWS есть такой тип ресурса, как SPOT инстансы (виртуальные машины, цена на которые динамически меняется). Цена на них значительно меньше, чем за инстансы с фиксированной ценой. Правила использования SPOT инстанса заключаются в том, что мы указываем определенный порог цены, который готовы платить за поддержание работы инстанса, если порог выше рыночной цены, то мы платим рыночную цену за инстанс, но как только цена превышает порог, то инстанс прекращает свою работу и удаляется. Данный проект нацелен предсказывать вероятность выживания самого популярного SPOT-инстанса с GPU в AWS (g5.2xlarge) в течение следующих суток. Используются открытые датасеты `
